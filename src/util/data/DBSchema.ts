// Auto-generated by WorkbookSchemaGenerator on 2025-09-25T09:13:57.107Z
...
export const requisitionDef: TableDefinition<Requisition> = {
  columns: {
    ...
    createdByName: { type: "string", calculated: true, final: true, referenceTo: "Person" },
    ...
    responsibleId: { type: "number", final: true, referenceTo: "RequisitionItem" },
    responsibleName: { type: "string", calculated: true, final: true, referenceTo: "RequisitionItem" },
    ...
    emailId: { type: "string", final: true }
  },
  names: {
    id: "Id",
    name: "Name",
  ...
  order: ["id", "name", "createdAt", "createdBy", "createdByName", "dueDate", "projectId", "projectName", "requisitionItems", "responsibleId", "responsibleName", "approvals", "approvedApprovals", "rejectedApprovals", "pendingApproval", "emailId"]
};
