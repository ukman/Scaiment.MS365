// Auto-generated by WorkbookSchemaGenerator on 2025-09-14T09:03:12.003Z
// Tables: items, Table9, Requisition, RequisitionItem, RequisitionApproval, Project, ProjectMember, Person, Unit, Role
...
export const itemsDef: TableDefinition<Items> = {
  columns: {
    t: { type: "number" },
    product: { type: "string" },
    unit: { type: "string" },
  ...
  order: ["t", "product", "unit", "quantity", "category", "comment"]
};
...
export const requisitionDef: TableDefinition<Requisition> = {
  columns: {
    ...
    approvals: { type: "string", final: true, referenceTo: "RequisitionItem" },
    approvedApprovals: { type: "string", final: true, referenceTo: "RequisitionItem" },
    rejectedApprovals: { type: "string", final: true, referenceTo: "RequisitionItem" },
    pendingApproval: { type: "string", final: true, referenceTo: "RequisitionItem" }
  },
  names: {
    id: "Id",
    name: "Name",
...
export const requisitionApprovalDef: TableDefinition<RequisitionApproval> = {
  columns: {
    ...
    createdAt: { type: "date", required: true, calculated: true, final: true },
    createdBy: { type: "number", required: true, final: true, referenceTo: "Person" },
    decisionDate: { type: "date", required: true, final: true },
